...
const UserSignup = () => {
  const handleSubmit = (event) => {
        ...
        axios.post("https://reflect-backend-p9344y5gu-mobashir1786.vercel.app/signup", { firstName: firstName,lastName:lastName, number: number, email: email, password: password })
            .then(res => {
                console.log(res)
